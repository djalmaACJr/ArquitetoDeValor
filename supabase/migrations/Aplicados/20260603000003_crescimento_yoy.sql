-- ============================================================
-- CRESCIMENTO: muda cálculo de crescimento
-- Antes: ano atual vs ano base
-- Agora: ano atual vs ano ANTERIOR (year-over-year)
--
-- valor_meta     = meta de crescimento anual (ex.: 5 = 5% ao ano)
-- valor_atingido = crescimento real do último ano vs ano anterior
-- percentual     = progresso relativo à meta (yoy / meta * 100)
-- ============================================================
...
BEGIN
    ...
    -- ── CRESCIMENTO: % de crescimento vs ano ANTERIOR (YoY) ───
    ELSIF NEW.tipo = 'CRESCIMENTO' THEN
        ...
        IF array_length(v_cats, 1) > 0 THEN
            ...
            -- Ano anterior: nunca menor que o ano base
