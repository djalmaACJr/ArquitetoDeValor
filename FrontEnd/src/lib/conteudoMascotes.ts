...
export const DICAS: Record<MascoteNome, Dica[]> = {
  ...
  sabio: [
    ...
    // ── Lote +50 (2026-11) ─────────────────────────────────────────
    { tema: 'promessa',      pose: 'sentado',   texto: 'Cada centavo guardado hoje é uma promessa feita ao seu eu de daqui a 20 anos. Honre essa palavra.' },
    { tema: 'hábito',        pose: 'andando',   texto: 'Pague-se primeiro. Aporte ANTES de qualquer outra despesa do mês — o que sobra é o que você tinha de verdade.' },
    { tema: 'euforia',       pose: 'espantado', texto: 'Quando todos garantem "essa nunca cai", lembre que essa frase ecoou em 1929, em 2000, em 2008. A história não repete, mas rima.' },
    { tema: 'comparação',    pose: 'sentado',   texto: 'Não compare seu capítulo 3 com o capítulo 20 do outro. Cada jornada financeira tem seu ritmo.' },
    { tema: 'hábito',        pose: 'curioso',   texto: 'Quem registra suas despesas por 90 dias enxerga o invisível. O orçamento não muda no papel — muda na consciência.' },
    { tema: 'fraude',        pose: 'espantado', texto: 'Promessa de "lucro fácil" raramente é lucro. Geralmente é o seu dinheiro indo embora sob nome bonito.' },
    { tema: 'recomeço',      pose: 'feliz',     texto: 'Errou ontem? Recomece hoje. O mercado não cobra arrependimento — cobra reação.' },
    { tema: 'ordem',         pose: 'sentado',   texto: 'Antes de subir o padrão de vida, sobe o padrão de poupança. A ordem importa.' },
    { tema: 'dívida',        pose: 'espantado', texto: 'Endividar-se pra investir é dança com o diabo. Quem ganhou conta histórias; quem perdeu, esconde.' },
    { tema: 'paciência',     pose: 'feliz',     texto: 'O patrimônio se constrói uma decisão por vez. A próxima decisão é sua.' },
    { tema: 'rotina',        pose: 'sentado',   texto: 'Reveja seu orçamento toda primeira quinta-feira do mês. Frequência cria o hábito; o hábito cria o resultado.' },
    { tema: 'riqueza',       pose: 'curioso',   texto: 'Quem confunde renda com riqueza vive sempre apertado, ganhe o que ganhar.' },
    { tema: 'experiência',   pose: 'sentado',   texto: 'Já fui pobre. Já fui apertado. Hoje sei: o que muda não é o salário — é a disciplina.' },
    { tema: 'consumo',       pose: 'curioso',   texto: 'Antes de gastar, pergunte: "Vou lembrar dessa compra daqui a 1 ano?". A maioria das ruins falha nesse teste.' },
    { tema: 'aviso',         pose: 'sentado',   texto: 'Cuidado com o "só desta vez". Geralmente vira "só desta vez por mês" — e o orçamento sangra devagar.' },
    { tema: 'hábito',        pose: 'sentado',   texto: 'O hábito é mais forte que a motivação. Por isso, automatize tudo que puder. Motivação cansa; sistema persiste.' },
    { tema: 'propósito',     pose: 'sentado',   texto: 'Anote sua razão financeira (o porquê) em algum lugar visível. Quando a tentação chegar, leia antes de gastar.' },
    { tema: 'consumo',       pose: 'espantado', texto: 'Ofertas com "tempo limitado" existem pra desligar seu pensamento. Compre sempre com 24 horas de distância.' },
    { tema: 'vida',          pose: 'sentado',   texto: 'Saúde, tempo e dinheiro — quem cuida dos três por décadas é raro. Você ainda pode ser um deles.' },
    { tema: 'rotina',        pose: 'curioso',   texto: 'Reveja contratos de seguro, plano de saúde e telefonia uma vez por ano. Mudou de fase de vida? Renegocie.' },
    { tema: 'dívida',        pose: 'espantado', texto: 'Empréstimo consignado parece amigo, mas é o último que sai do salário. Pode te prender por anos.' },
    { tema: 'consistência',  pose: 'sentado',   texto: 'Mil pequenas decisões certas valem mais que uma jogada brilhante. A consistência é o brilho silencioso.' },
    { tema: 'aprendizado',   pose: 'curioso',   texto: 'Antes de gastar com aulas pra ganhar mais, gaste tempo dominando o que já tem. Quem otimiza o atual aprende mais rápido.' },
    { tema: 'consumo',       pose: 'espantado', texto: 'Carro novo é o conforto mais caro do mundo. Em 5 anos vale metade — e a metade que sumiu pagaria muito.' },
    { tema: 'consistência',  pose: 'feliz',     texto: 'Você não precisa ser o mais inteligente. Precisa ser o mais consistente. Vence quem está lá no fim.' },
    { tema: 'família',       pose: 'sentado',   texto: 'Casamento financeiro: conversa de dinheiro entre parceiros, todo mês. Sem tabu, sem cobrança. Só transparência.' },
    { tema: 'procrastinação',pose: 'triste',    texto: '"Vou começar quando ganhar mais" é a mentira mais cara que dizemos a nós mesmos.' },
    { tema: 'tempo',         pose: 'sentado',   texto: 'Daqui a 10 anos, alguém vai dizer "queria ter começado em 2026". Não seja essa pessoa.' },
    { tema: 'consciência',   pose: 'curioso',   texto: 'Caderninho ao lado da carteira: anote cada gasto em dinheiro do dia. A clareza muda comportamento mesmo sem cortar nada.' },
    { tema: 'fraude',        pose: 'espantado', texto: 'Pirâmides financeiras prometem "renda passiva fácil". Renda passiva real exige patrimônio acumulado.' },
    { tema: 'recomeço',      pose: 'feliz',     texto: 'Você não está atrasado. Está exatamente onde a maioria começa — agora.' },
    { tema: 'renda-extra',   pose: 'sentado',   texto: 'Toda renda extra: 50% pra reserva ou investimento, 30% pra prazer planejado, 20% pra abater dívidas.' },
    { tema: 'aviso',         pose: 'sentado',   texto: 'Não confunda otimismo com plano. Esperança não paga conta — depósito sim.' },
    { tema: 'liberdade',     pose: 'feliz',     texto: 'A liberdade financeira não é luxo. É a possibilidade de dizer "não" sem pagar caro por isso.' },
    { tema: 'aporte',        pose: 'sentado',   texto: 'Antes de cancelar um aporte por aperto, corte 1 despesa fixa. O aporte é o que constrói; a despesa, o que dispersa.' },
    { tema: 'aviso',         pose: 'espantado', texto: 'Garantir empréstimo de terceiro tem cara de amizade, custa como dívida própria. Pense antes do "sim".' },
    { tema: 'simplicidade',  pose: 'sentado',   texto: 'O dia em que parar de procurar a fórmula mágica e começar a aportar é o dia em que a vida financeira muda.' },
    { tema: 'consumo',       pose: 'curioso',   texto: 'Defina um "dia da semana sem gasto". 4 dias por mês × 12 = 48 dias por ano. Soma.' },
    { tema: 'alavancagem',   pose: 'espantado', texto: 'Cuidado com a "calculinha" mental: "se eu pego 100 mil emprestado e investir, ganho a diferença". Quase sempre dá errado.' },
    { tema: 'experiência',   pose: 'triste',    texto: 'A pior fase financeira da minha vida foi a melhor escola que tive. Cada aperto ensina algo que livro nenhum cobre.' },
    { tema: 'preparo',       pose: 'sentado',   texto: 'Antes de qualquer investimento novo, leia o regulamento ou prospecto. 30 minutos hoje salvam anos de erro.' },
    { tema: 'aviso',         pose: 'curioso',   texto: 'Comprar pra "guardar e vender mais caro" só funciona quando há demanda futura e estoque escasso. Em dúvida, não compre.' },
    { tema: 'meta',          pose: 'sentado',   texto: 'Onde você quer estar em 5 anos? Volte ao hoje e veja se está caminhando pra lá. Pequenas correções a tempo importam.' },
    { tema: 'reserva',       pose: 'sentado',   texto: 'Reserva primeiro, sempre. Sem ela, qualquer susto vira dívida nova e cancela meses de aporte.' },
    { tema: 'aprendizado',   pose: 'curioso',   texto: 'Não confunda "investir em si" com "gastar com cursos". Investir é o que muda comportamento. O resto é só certificado.' },
    { tema: 'identidade',    pose: 'feliz',     texto: 'Você é maior que a soma das suas compras. O que define seu valor não é o que você tem.' },
    { tema: 'planejamento',  pose: 'sentado',   texto: 'Lance hoje as despesas previstas pro mês. Quando elas chegarem, você já decidiu antes — emoção fica fora.' },
    { tema: 'aviso',         pose: 'curioso',   texto: 'Quem investe e fala alto sobre lucros geralmente esconde as perdas. Use estatística, não anedotas.' },
    { tema: 'persistência',  pose: 'feliz',     texto: 'O caminho parece longo no começo. Olhe pra trás depois de 1 ano — você passou mais do que pensava.' },
    { tema: 'revisão',       pose: 'sentado',   texto: 'No fim do ano, faça o "balanço anual": receita total, despesa total, patrimônio em 31/12. Compare com o ano anterior. Tendência > momento.' },
  ],
  ...
  arquiteta: [
    ...
    // ── Lote +50 (2026-11) ─────────────────────────────────────────
    { tema: 'transporte',    pose: 'curioso',   texto: 'Some seus gastos com transporte. Se passou de 15% da renda, há otimização: rota, modal ou frota.' },
    { tema: 'método',        pose: 'feliz',     texto: 'Você não precisa ganhar mais. Precisa entender pra onde vai o que já ganha.' },
    { tema: 'aviso',         pose: 'sentado',   texto: '"Saldo bom" no fim do mês não significa orçamento saudável. Pode ser sorte estatística — meça 6 meses pra ter certeza.' },
    { tema: 'anual',         pose: 'curioso',   texto: 'Reserve uma planilha só pra despesas anuais: IPVA, IPTU, seguros, escola. Divida por 12 e inclua no mensal. Acabou o susto.' },
    { tema: 'método',        pose: 'feliz',     texto: 'Estrutura libera. O que parece controle rígido é, na verdade, autonomia conquistada com método.' },
    { tema: 'aporte',        pose: 'espantado', texto: 'Aporte irregular não constrói patrimônio — constrói extrato confuso. Frequência fixa, valor variável é OK; o oposto não.' },
    { tema: 'categoria',     pose: 'curioso',   texto: 'Categoria "Outros" acima de 10% é sinal de subdivisão pendente. Divida em pelo menos 3 subcategorias específicas.' },
    { tema: 'método',        pose: 'feliz',     texto: 'Quem mede, decide. Quem decide com base em dados, acerta mais. Você está construindo essa vantagem agora.' },
    { tema: 'renda-extra',   pose: 'sentado',   texto: 'Cuidado com "renda extra" virando "despesa extra". O 13º deveria ir 70% pra reserva ou amortização, não pra consumo.' },
    { tema: 'meta',          pose: 'sentado',   texto: 'Margem de segurança: aporte − meta mensal = sobra. Sobra positiva consistente? Suba a meta em 5%.' },
    { tema: 'método',        pose: 'feliz',     texto: 'Cada planilha atualizada é um pequeno acordo com o futuro. Você está honrando o seu eu de daqui a 10 anos.' },
    { tema: 'cartão',        pose: 'espantado', texto: 'Cartão de crédito com limite alto é tentação institucionalizada. Mantenha o limite em 1× sua renda mensal — não mais.' },
    { tema: 'cálculo',       pose: 'sentado',   texto: 'Antes de financiar um bem, calcule o CET (Custo Efetivo Total). 1,99% ao mês vira 26,82% ao ano — sem mistério, só matemática.' },
    { tema: 'simplicidade',  pose: 'feliz',     texto: 'O orçamento perfeito não existe. O útil sim. Comece com 5 categorias. Ajuste com o tempo.' },
    { tema: 'aviso',         pose: 'curioso',   texto: '"Saldo na conta" não é poupança — é fluxo. Se está parado lá há 30 dias, deveria estar rendendo.' },
    { tema: 'cálculo',       pose: 'sentado',   texto: 'Calcule sua "renda real": salário líquido − INSS − IR − vale-refeição (que vai pra alimentação). É menor do que você pensa, e é o que cabe no orçamento.' },
    { tema: 'método',        pose: 'feliz',     texto: 'Você já é um pequeno investidor. Aplicou em si, em casa, em educação. Agora é só formalizar o método.' },
    { tema: 'dívida',        pose: 'espantado', texto: 'Empréstimo "pré-aprovado" no app do banco é uma armadilha de conveniência. Pré-aprovado pra quem? Pra quem vai pagar juros.' },
    { tema: 'transição',     pose: 'curioso',   texto: 'Quando trocar de emprego, recalcule TODO o orçamento — não só a receita. Despesas mudam com o cargo (vestuário, transporte, alimentação).' },
    { tema: 'aporte',        pose: 'feliz',     texto: 'Cada aporte automatizado é uma decisão que você não precisa tomar de novo. Decidir uma vez é descansar mil.' },
    { tema: 'fraude',        pose: 'espantado', texto: 'Investimento com "rentabilidade garantida acima do CDI" prometida por estranho: é golpe ou fraude. Sem exceção.' },
    { tema: 'aporte',        pose: 'sentado',   texto: 'Aporte mínimo viável: 10% da renda. Abaixo disso, não constrói patrimônio significativo em 30 anos.' },
    { tema: 'método',        pose: 'feliz',     texto: 'Disciplina financeira não é restrição — é direção. Você não corta gastos; canaliza recursos.' },
    { tema: 'liquidez',      pose: 'espantado', texto: 'Conta-corrente sem rendimento é doação ao banco. CDB liquidez diária paga ~95% do CDI. Mude hoje.' },
    { tema: 'assinaturas',   pose: 'curioso',   texto: 'Faça uma "auditoria de assinaturas" trimestral. Streaming, app, academia. Cancele o que não usou em 60 dias.' },
    { tema: 'consistência',  pose: 'feliz',     texto: 'Patrimônio é construído centavo a centavo, decisão a decisão. Nada é desprezível.' },
    { tema: 'imóvel',        pose: 'espantado', texto: 'Comprar imóvel "como investimento" sem cálculo é amador. Cap rate ≥ 0,6% ao mês líquido pra fazer sentido frente a renda fixa.' },
    { tema: 'estrutura',     pose: 'sentado',   texto: 'Crie um "fundo de oportunidade" separado da reserva: 5% da renda. Quando aparecer oportunidade real, você tem munição.' },
    { tema: 'método',        pose: 'feliz',     texto: 'O que se mede, se gerencia. O que se gerencia, melhora. Você está no segundo estágio.' },
    { tema: 'aviso',         pose: 'espantado', texto: 'Refinanciar imóvel pra investir é equação de risco. Só faz sentido se o líquido pós-imposto SUPERAR a parcela do financiamento — raríssimo.' },
    { tema: 'consignado',    pose: 'sentado',   texto: 'Crédito consignado: máximo 20% da renda. Acima disso, asfixia. Calcule SEMPRE antes de assinar.' },
    { tema: 'confiança',     pose: 'feliz',     texto: 'Você é mais capaz que se julga. Métricas vão provar — basta começar a registrar.' },
    { tema: 'fraude',        pose: 'espantado', texto: 'Promessa de "renda passiva milionária em 12 meses" é fraude. Renda passiva real toma 10-20 anos pra ser significativa.' },
    { tema: 'cálculo',       pose: 'curioso',   texto: 'Aporte mensal × 12 × 30 ÷ 2 ≈ valor acumulado em 30 anos a 8% ao ano. Fórmula aproximada, útil pra estimativas rápidas.' },
    { tema: 'identidade',    pose: 'sentado',   texto: 'Cada categoria do orçamento é uma decisão que você está tomando sobre quem quer ser. Categorize bem.' },
    { tema: 'consumo',       pose: 'curioso',   texto: '"Comprar antes que aumente" geralmente vira "comprar e depois descobrir que não precisava". Espere 7 dias — quase tudo continua disponível.' },
    { tema: 'autônomo',      pose: 'sentado',   texto: 'Para autônomos: separe conta jurídica da pessoal. Diga "PJ paga PF" um salário fixo mensal. Resto fica como caixa da empresa.' },
    { tema: 'controle',      pose: 'feliz',     texto: 'Você está no controle. Cada lançamento que registra é uma escolha consciente sobre o futuro.' },
    { tema: 'cartão',        pose: 'espantado', texto: 'Cartão com taxa rotativo bate 400% ao ano. Pagar mínimo é entregar o controle pro banco. Saia do rotativo em até 30 dias.' },
    { tema: 'presentes',     pose: 'curioso',   texto: 'Reserve um envelope (mental ou real) pra "presentes do ano": aniversários, Natal, casamentos. R$ 100/mês × 12 = R$ 1.200 — geralmente suficiente.' },
    { tema: 'decisão',       pose: 'feliz',     texto: 'Não há decisão financeira perfeita. Há decisão informada — e essa, você já consegue tomar.' },
    { tema: 'consórcio',     pose: 'espantado', texto: 'Compra coletiva de imóvel (consórcio) tem prazo médio de contemplação de 30 meses. Calcule o custo do tempo antes de assinar.' },
    { tema: 'patrimônio',    pose: 'sentado',   texto: 'Patrimônio líquido cresce de 3 jeitos: aumentar ativos, reduzir passivos, ou ambos. Mire 1 dos 3 por mês.' },
    { tema: 'método',        pose: 'feliz',     texto: 'Estrutura primeiro, estética depois. Plano organizado dispensa heroísmo emocional.' },
    { tema: 'aviso',         pose: 'sentado',   texto: '"Quero juntar pra dar entrada" sem reserva primeiro: depois da entrada, qualquer susto te derruba. Reserva antes de meta.' },
    { tema: 'cenário',       pose: 'curioso',   texto: 'Antes de assinar contrato, calcule cenário ruim (perda de emprego, doença, separação). Suporta? Assine. Não suporta? Renegocie.' },
    { tema: 'projeção',      pose: 'feliz',     texto: 'Você não está só sobrevivendo — está projetando. A diferença entre os dois é a planilha.' },
    { tema: 'fraude',        pose: 'espantado', texto: '"Investimento que rende 50% ao mês" só existe em propaganda. Mercado real entrega 0,8% ao mês em renda fixa. Aceite o real.' },
    { tema: 'essencial',     pose: 'sentado',   texto: 'Despesa essencial: aquela que, se cortar, gera consequência grave em 30 dias (aluguel, comida, remédio). Tudo o mais é variável — e ajustável.' },
    { tema: 'autonomia',     pose: 'feliz',     texto: 'Métrica clara hoje, decisão certa amanhã. Você está construindo o esqueleto da sua autonomia.' },
  ],
