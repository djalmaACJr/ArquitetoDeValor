  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto flex flex-col gap-5">
      ...
      <section className="bg-[#1a1f2e] rounded-xl p-5 border border-white/5">
        ...
        {/* Destaque do último módulo: Objetivos */}
        <div className="mt-4 pt-4 border-t border-white/8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div>
              <p className="text-[14px] font-semibold text-white/85">Novo módulo: Objetivos Financeiros</p>
          ...
          <p className="text-[13px] leading-relaxed mb-3" style={{ color: '#8b92a8' }}>
            Defina metas de longo prazo e acompanhe o progresso automaticamente — o sistema
            recalcula tudo a partir dos seus lançamentos e saldos. São três tipos:
          </p>
          ...
          <p className="text-[13px] leading-relaxed" style={{ color: '#8b92a8' }}>
            Cada objetivo tem uma página de detalhes com gráficos de evolução, barras empilhadas
            por categoria, ranking de ativos e barras divergentes de crescimento — além de um
            tutorial guiado próprio para começar rápido.
          </p>
        </div>
      </section>
